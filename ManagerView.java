...
public class ManagerView {
  ...
  private void initialize() {
    ...
    tabbedPane.addTab("Quan Ly Hang Hoa", null, goodsTab, null);
    ...
    JLabel lblDateExpire = new JLabel("Ngay San Xuat");
    ...
    JLabel lblProducer = new JLabel("Ngay Het Han");
    ...
    JLabel lblInputNumberImport = new JLabel("Luong Hang Nhap");
    ...
    JButton btnGenerateCode = new JButton("Tao Ma Cho San Pham");
    ...
    JLabel lblImportGoodsTo = new JLabel("Nhap Hang Vao Kho");
    ...
    com2.setModel(new DefaultComboBoxModel<String>(new String[] {
        "Tuy chon . . .", "Ban ra nhieu nhat", "Ban ra it nhat",
        "San pham da ban het", "San pham het han su dung "}));
    ...
    tabbedPane.addTab("Quan Ly Nhan Vien", null, employeeTab, null);
    ...
    JLabel lblEmployeeList = new JLabel("Danh Sach Nhan Vien");
    ...
    JLabel lblTen = new JLabel("Ho va Ten");
    ...
    JLabel lblNgayBatDauLam = new JLabel("Ngay Bat Dau Lam");
    ...
    JLabel lblMaNhanVien = new JLabel("Ma So Nhan Vien");
