...
public class ConnDb {
  ...
  public static void saveEmployeeAccount(Employee employee) {
    ...
    String sqlQuery = "UPDATE `account_tb` SET `userID` = '" + a.getAccountName() 
  ...
  public static void saveGoodsAfterSold(Goods goods) {
    ConnDb conn = new ConnDb();
    String sqlQuery = "UPDATE `goods_tb` SET `amountReamain` = '" + goods.getAmountReamain()
  ...
  public static void saveGoodsAfterImported(Goods goods) {
    ...
    try {
      ...
      String sqlQuery = "INSERT INTO `goods_tb` (`name`, `code`, `price`, `producedate`,"
          + " `expiredate" + "`, `producer`, `amountReamain`, `amountSold`) " + "VALUES ("
  ...
  public static int getNumberGoodsWithZeroAmount() {
    ConnDb conn = new ConnDb();
    String sqlQuery = "SELECT * FROM `goods_tb` WHERE `amountReamain` = 0";
    ResultSet rs = conn.getResult(sqlQuery);
    int count = 0;
    try {
      while (rs.next()) {
  ...
  public static ArrayList<Goods> getListGoodsWithZeroAmount() {
    ArrayList<Goods> g = new ArrayList<>();
    ConnDb conn = new ConnDb();
    String sqlQuery = "SELECT * FROM `goods_tb` WHERE `amountReamain` LIKE 0 ";
    ResultSet rs = conn.getResult(sqlQuery);
    Goods goods = null;
    try {
      while (rs.next()) {
  ...
  * @return boolean value
  ...
  public static void saveNewEmployeeId(Account account) {
    String sqlQuery = "INSERT INTO `account_tb` (`userID`, `password`, `employeeID`) VALUES "
  ...
  public static void savaAccountInfo(Account account) {
    String sqlQuery = "UPDATE `account_tb` SET `userID` = '" + account.getAccountName() 
