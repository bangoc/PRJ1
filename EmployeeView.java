...
public class EmployeeView {
  ...
  private void initialize() {
    ...
    tabbedPane.addTab("Ban Hang", null, saleTab, null);
    saleTab.setLayout(null);
    
    JLabel lblMaSanPham = new JLabel("Ma San Pham");
    ...
    JButton btnInsert = new JButton("Them Vao Hoa Don");
    ...
    tabbedPane.addTab("Trang Ca Nhan", null, informationTab, null);
    ...
    JLabel lblThongTinCa = new JLabel("Thong Tin Ca Nhan");
    ...
    JLabel lblNgayLam = new JLabel("Ngay Bat Dau Lam");
    ...
    JLabel lblMaSoNhan = new JLabel("Ma So Nhan Vien");
    ...
    JLabel lblLuongTheoCa = new JLabel("Luong Theo Ca");
    ...
    JLabel lblSoCaLam = new JLabel("So Ca Lam Viec");
